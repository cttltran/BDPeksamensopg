...
% Last Modified by GUIDE v2.5 25-May-2018 14:35:53
...
% --- Executes on slider movement.
function sldcontrast1_Callback(hObject, eventdata, handles)
% hObject    handle to sldcontrast1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sldcontrast1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sldcontrast1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function menuExclude_Callback(hObject, eventdata, handles)
% hObject    handle to menuExclude (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns menuExclude contents as cell array
%        contents{get(hObject,'Value')} returns selected item from menuExclude


% --- Executes during object creation, after setting all properties.
function menuExclude_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menuExclude (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function sldEcho_Callback(hObject, eventdata, handles)
% hObject    handle to sldEcho (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sldEcho_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sldEcho (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
