...
if dirName ~= 0
    ...
    for ii=1:numFiles
        ...
        if isempty(strfind(Info.SeriesDescription,'T2*'))
            ...
            handles.imgT2(countT2).PatientID = Info.PatientID;
...
% Setup slider and texts when files are loaded
...
set(handles.txtPatient,'String',sprintf('%s',handles.imgT2(1).PatientID))
